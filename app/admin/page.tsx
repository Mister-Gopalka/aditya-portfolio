...
import { getFontPairing, getProjectVisibility } from "@/lib/supabase";
  ...
  return (
    <div className="min-h-screen bg-[#FFF8F3]">
      <div className="max-w-3xl mx-auto px-4 py-12">
        <a href="/" className="text-sm text-[#1C0A00]/50 hover:text-[#E8604A] transition-colors">
          ← Back to site
        </a>
        ...
        <AdminPanel currentPairing={currentPairing} projects={projectList} />
      </div>
    </div>
  );
}
