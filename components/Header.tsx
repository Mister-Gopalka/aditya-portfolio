  ...
  return (
    <header className="sticky top-0 z-50 bg-[#FFF8F3]/90 backdrop-blur-sm border-b border-[#1C0A00]/8">
      <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
        <a href="/" className="font-heading text-lg font-bold text-[#1C0A00] tracking-tight">
          Aditya Gopalka
        </a>
        <a
          href={whatsappUrl}
          ...
          className="inline-flex items-center gap-2 bg-[#E8604A] text-white text-sm font-medium px-4 py-2 rounded-full hover:bg-[#d4513c] transition-colors"
        >
