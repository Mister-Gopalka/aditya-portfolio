  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#FFF8F3]">
      <div className="text-center">
        <p className="font-heading text-8xl font-bold text-[#E8604A] mb-4">404</p>
        ...
        <Link
          href="/"
          className="inline-flex items-center bg-[#1C0A00] text-[#FFF8F3] font-medium px-6 py-3 rounded-full hover:bg-[#E8604A] transition-colors"
        >
          ← Back to work
        </Link>
      </div>
